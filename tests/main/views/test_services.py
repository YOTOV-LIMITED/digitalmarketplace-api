...
from tests.helpers import (
    TEST_SUPPLIERS_COUNT, FixtureMixin, ExampleListingMixin, string_to_time, string_to_time_to_string
)
...
class TestPutService(BaseApplicationTest, ExampleListingMixin, JSONUpdateTestMixin):
    ...
    def test_add_a_new_service(self, search_api_client):
        with self.app.app_context():
            ...
            assert_almost_equal(
                string_to_time(service["updatedAt"], DATETIME_FORMAT),
                now,
